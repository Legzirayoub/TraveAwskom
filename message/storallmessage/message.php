			...
			<input type="submit" name="message" class="btn btn-info pull-right" value="Send Message">
			    ...
			    <?php 
				  if ( isset( $_POST['message'] ) ) {
					...
					$insert = "INSERT into messages(sender,receiver,message_topic,reply,status,message_type,message_date) values('$user_id','$user2_id','$message_topic','reply','nonvue','dad',NOW())";
