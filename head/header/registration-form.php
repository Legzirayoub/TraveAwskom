...
<h1><font color="black">  Welcome to Awskom :  For Everyone . Everywhere . Anytime .</font></h1>
<div class="row">
<div class="vl">
</div> 
<div class="col">
...
<br>
<td><input type="checkbox" name="terms">I accept<a href="policy.php">Terms and Conditions</a></td>
</table><br>
<button type="submit" name="submit" value="Register" class="btn btn-primary">Register</button></div>
<div class="col">
<div class="hide-md-lg">
</div><br>
<img src="img/abstract.png" alt="Bear" style="width:100%"><br>
</div> 
