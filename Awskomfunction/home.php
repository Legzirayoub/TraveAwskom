...
<?php 
		...
		?>
	<a href="my_profile_like_user01.php?user_id=<?php echo $user_id; ?>"><img src="userimage/<?php echo $user_image; ?>" class="img-circle"  alt="Bear" width="50px" height="50px"><?php echo $user_name; ?></a>: What's in your mind ?<img src="userimage/270f.png"  alt="Bear" width="20px" height="20px" >
	<ul class="list-group">
...
if just a comment write it normal without tags . " required>
</textarea>
